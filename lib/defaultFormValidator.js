 ...
 */
var DefaultFormValidator = /** @class */ (function (_super) {
    __extends(DefaultFormValidator, _super);
    /**
     * Message to display if errors.
     * @param error Error message
     */
    function DefaultFormValidator(error) {
     ...
     */
    DefaultFormValidator.prototype.check = function (value) {
