...
var FieldBase = /** @class */ (function () {
    function FieldBase(validators, value) {
     ...
     */
    FieldBase.prototype.getHasChanged = function () {
        var self = this;
        var changedVal = (self.initialValue !== JSON.stringify(self.value()));
        return changedVal;
    };
    /**
     * Assigns the current value to initialValue.
     */
    FieldBase.prototype.resetHasChanged = function () {
        var self = this;
